...
#define MAC_LOW_OFFSET MAC_BASE
#define MAC_HIGH_OFFSET MAC_BASE + MAC_LOW_BYTES
...
#define LNW_ECMP_NEXTHOP_TABLE_KEY_ECMP_NEXTHOP_ID "user_meta.cmeta.ecmp_nexthop_id"

#define LNW_ECMP_NEXTHOP_TABLE_ACTION_SET_ECMP_NEXTHOP_INFO_DMAC \
  "linux_networking_control.set_ecmp_nexthop_info_dmac"
